...
- :telescope: I’m working as a **Full-stack Developer**, developing and modifying layouts in **Front-End**, contributing to **Back-end** for **building and maintenance web applications** and participating in **Data Manipulation** for **creation of tables with inserts, deletes and updates** in database (MySQL and DB2).
